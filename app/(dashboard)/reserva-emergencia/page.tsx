    ...
    <form onSubmit={handleSubmit(onSave)} className="mt-2 space-y-4">
      {suggestedTargets && (
        <div className="space-y-2">
          <p className="text-xs text-app-soft">Metas sugeridas com base nos seus gastos essenciais:</p>
          <div className="grid grid-cols-3 gap-2">
            {([
              { label: '3 meses', value: suggestedTargets.m3 },
              { label: '6 meses', value: suggestedTargets.m6 },
              { label: '12 meses', value: suggestedTargets.m12 },
            ] as const).map(({ label, value }) => (
              <button
                key={label}
                type="button"
                onClick={() => setValue('targetAmount', String(value))}
                className="rounded-[8px] px-2 py-2 text-center text-xs font-semibold transition-colors"
                style={{
      ...
      <div className="space-y-2">
        <Label className="text-app-base">Meta da reserva (R$)</Label>
        <Input
          type="text"
          inputMode="decimal"
      ...
      <div className="space-y-2">
        <Label className="text-app-base">Saldo inicial da reserva (R$)</Label>
        <Input
          type="text"
          inputMode="decimal"
          placeholder="Ex: 5000"
        ...
        <p className="text-xs text-app-soft">
          Valor que já existe guardado antes de registrar aportes aqui.
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        />
        <p className="text-xs text-app-soft">
          Usado para projetar em quanto tempo você atingirá a meta.
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <Input
          placeholder="Ex: Guardado no Tesouro Selic"
          className="rounded-[8px]"
          style={{
            background: 'var(--panel-bg-soft)',
            borderColor: 'var(--panel-border)',
...
function MovementForm({
  ...
  const ENTRY_TYPE_CONFIG = {
    ...
    ajuste: { label: 'Ajuste de saldo', icon: SlidersHorizontal, color: '#94a3b8' },
  }
  ...
  return (
    <form onSubmit={handleSubmit(onSave)} className="mt-2 space-y-4">
      ...
      <div className="space-y-2">
        ...
        <Input
          placeholder="Ex: Transferência para CDB"
          className="rounded-[8px]"
          style={{
            background: 'var(--panel-bg-soft)',
            borderColor: 'var(--panel-border)',
  ...
  return (
    <div className="panel-card p-5">
      <div className="mb-3 flex items-center justify-between">
        <p className="text-sm font-semibold text-app">Progresso da reserva</p>
        <span
      ...
      <div className="mt-2 flex items-center justify-between text-xs text-app-soft">
        <span>{formatCurrency(current)} guardados</span>
  ...
  return (
    <div className="mx-auto max-w-2xl pb-24 md:pb-0">
        ...
        <div className="space-y-5">
          ...
          {!reserve && (
            ...
            >
              ...
              />
              <p className="font-semibold text-app">Configure sua reserva de emergência</p>
              <p className="mt-1 text-sm text-app-soft">
                Defina uma meta e comece a acompanhar sua proteção financeira.
              </p>
              <Button
                onClick={() => setTargetModalOpen(true)}
          ...
          {/* KPI Cards */}
          <ReserveKpiCards scope="personal" metrics={metrics} />
      ...
      <Modal
        ...
        title="Configurar meta da reserva"
        description="Defina o valor alvo e o saldo inicial da sua reserva."
      >
        <TargetConfigForm
          onClose={() => setTargetModalOpen(false)}
      ...
      <Modal
        ...
        description="Registre aportes, resgates ou ajustes na reserva."
      >
        <MovementForm
          onClose={() => setMovementModalOpen(false)}
